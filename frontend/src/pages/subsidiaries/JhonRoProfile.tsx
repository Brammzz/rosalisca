...
const JhonRoProfile = () => {
  ...
  const { data: companyData, isLoading: isLoadingCompany, isError: isErrorCompany } = useCompanyBySlug('jhon-dan-ro');
  
  const { data: certificateData, isLoading: isLoadingCertificates, isError: isErrorCertificates } = useQuery({
    queryKey: ['certificates', { subsidiary: 'PT. JOHN DAN RO' }],
    queryFn: () => getCertificatesAPI({ subsidiary: 'PT. JOHN DAN RO', limit: 100 }),
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="animate-fade-in">
                ...
                <p className="text-xl md:text-2xl text-white/95 mb-0 max-w-4xl mx-auto leading-relaxed px-4 drop-shadow-lg">
                  {company.description || 'Perusahaan konstruksi berpengalaman dengan komitmen tinggi terhadap kualitas dan inovasi'}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="order-2 lg:order-1">
                <div className="relative">
                  <img
                    src={company.logo || "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"}
                    alt={`${company.name} Office`}
                    className="w-full h-96 object-cover rounded-2xl shadow-xl"
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
                      target.src = "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80";
                    }}
                  />
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="bg-construction-gray-50 p-6 rounded-xl text-center">
                    <div className="text-2xl font-bold text-construction-blue-600 mb-2">
                      {company.establishedYear || '1982'}
                    </div>
                    <div className="text-sm text-construction-gray-600">Tahun Didirikan</div>
                  </div>
                  <div className="bg-construction-gray-50 p-6 rounded-xl text-center">
                    <div className="text-2xl font-bold text-construction-blue-600 mb-2">40+</div>
                  ...
                  {company.history ? (
                    ...
                    <div className="space-y-6">
                      <p className="text-lg leading-relaxed">
                        <strong>{company.name}</strong> didirikan pada tahun <strong>{company.establishedYear || '2012'}</strong> sebagai perusahaan yang 
                        bergerak dalam bidang konstruksi umum dengan fokus pada pembangunan dan konstruksi real estate.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Perusahaan ini berspecialisasi dalam <strong>Pengolahan Air Limbah & Sistem Drainase</strong>.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Berkedudukan di {company.address ? company.address.split(',')[0] : 'Jl. TB Simatupang Kav. 1'} dan mempunyai cabang atau 
                        perwakilan di tempat lain, {company.name} mengandalkan karyawan yang unggul dan kepuasan klien sebagai motivasi 
                        utama dalam setiap proyek yang dikerjakan.
                      </p>
                    </div>
                  )}
                </div>
              ...
              {!company.vision && !company.mission && (
                <>
                  <div className="bg-white p-8 rounded-2xl shadow-lg">
                    <h3 className="text-2xl font-heading font-bold text-construction-blue-600 mb-6">Visi</h3>
                    <p className="text-lg text-construction-gray-700 leading-relaxed">
                      Menjadi perusahaan konstruksi yang unggul dan terpercaya dalam memberikan solusi terbaik untuk setiap kebutuhan pembangunan infrastruktur.
                    </p>
                  </div>
                  <div className="bg-white p-8 rounded-2xl shadow-lg">
                    <h3 className="text-2xl font-heading font-bold text-construction-blue-600 mb-6">Misi</h3>
              ...
              {/* <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  <Button asChild className="w-full bg-construction-blue-600 hover:bg-construction-blue-700">
                    <Link to="/business-units/jhon-ro/projects">
                  ...
                  <Button asChild variant="outline" className="w-full border-construction-blue-600 text-construction-blue-600 hover:bg-construction-blue-50">
                    <Link to="/business-units/jhon-ro/download">

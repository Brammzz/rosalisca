              ...
              <div>
                ...
                <div className="space-y-4 text-lg text-construction-gray-600">
                  {company.history ? (
                    ...
                    <>
                      <p>
                        {company.name} didirikan pada <strong>{company.establishedYear || '1982'}</strong> sebagai perusahaan yang bergerak dalam bidang konstruksi umum dengan fokus pada pembangunan dan konstruksi real estate.
                      </p>
                      <p>
                        Perusahaan ini berspecialisasi dalam {company.specialization || 'perencanaan, pelaksanaan konstruksi gedung, jembatan, jalan, pengairan, irigasi, pengadaan barang dan jasa, serta survey dan pemetaan'}.
                      </p>
                      <p>
                        Berkedudukan di {company.address ? company.address.split(',')[0] : 'Jakarta'} dan mempunyai cabang atau perwakilan di tempat lain, {company.name} mengandalkan karyawan yang unggul dan kepuasan klien sebagai motivasi utama dalam setiap proyek yang dikerjakan.
                      </p>
                    </>
                  )}
                </div>

              ...
              <div>
                ...
                <div className="space-y-4 text-lg text-construction-gray-600">
                  {company.history ? (
                    ...
                    <>
                      <p>
                        {company.name} didirikan pada <strong>{company.establishedYear || '2003'}</strong> sebagai perusahaan yang bergerak dalam bidang kontraktor umum dengan spesialisasi dalam pembangunan dan konstruksi real estate.
                      </p>
                      <p>
                        Perusahaan ini memiliki keahlian komprehensif dalam {company.specialization || 'perencanaan, pelaksanaan konstruksi gedung, jembatan, jalan, sistem pengairan dan irigasi, pengadaan barang dan jasa, serta survey dan pemetaan'}.
                      </p>
                      <p>

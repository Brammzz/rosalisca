...
import { Building, Award, MapPin, Phone, Mail, Download } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Link } from 'react-router-dom';
import { useQuery } from '@tanstack/react-query';
import { getCertificatesAPI, getTypeLabel , Certificate } from '@/services/certificateService';
import { useCompanyBySlug } from '@/hooks/useCompany';
import CertificateCard from '@/components/CertificateCard';
import { X, Loader2 } from 'lucide-react';

const ArimadaPersadaProfile = () => {
  const [selectedCertificate, setSelectedCertificate] = React.useState<Certificate | null>(null);

  // Fetch company data by slug
  const { data: companyData, isLoading: isLoadingCompany, isError: isErrorCompany } = useCompanyBySlug('arimada-persada');

  const { data: certificateData, isLoading: isLoadingCertificates, isError: isErrorCertificates } = useQuery({
    queryKey: ['certificates', { subsidiary: 'PT. ARIMADA PERSADA' }],
    queryFn: () => getCertificatesAPI({ subsidiary: 'PT. ARIMADA PERSADA', limit: 100 }),
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="animate-fade-in">
                ...
                <p className="text-xl md:text-2xl text-white/95 mb-0 max-w-4xl mx-auto leading-relaxed px-4 drop-shadow-lg">
                  {company.description || 'Perusahaan konstruksi inovatif dengan komitmen pada kualitas dan kepuasan pelanggan'}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="order-2 lg:order-1">
                <div className="relative">
                  <img
                    src={company.logo || "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"}
                  ...
                  {company.history ? (
                    ...
                    <div className="space-y-6">
                      <p className="text-lg leading-relaxed">
                        ...
                        bergerak dalam bidang kontraktor umum dengan spesialisasi dalam pembangunan dan konstruksi real estate.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Perusahaan ini memiliki keahlian komprehensif dalam perencanaan, pelaksanaan konstruksi gedung, jembatan, jalan, sistem pengairan dan irigasi, pengadaan barang dan jasa, serta survey dan pemetaan.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Berkedudukan di {company.address ? company.address.split(',')[0] : 'Jakarta'} dan mempunyai cabang atau perwakilan di berbagai lokasi strategis, {company.name} mengutamakan karyawan yang unggul dan kepuasan klien sebagai motivasi utama dalam setiap proyek.
                      </p>
                    </div>
                  )}
                </div>
              ...
              {!company.vision && !company.mission && (
                <>
                  <div className="bg-white p-8 rounded-2xl shadow-lg">
                    <h3 className="text-2xl font-heading font-bold text-construction-blue-600 mb-6">Visi</h3>
                    <p className="text-lg text-construction-gray-700 leading-relaxed">
                      Menjadi perusahaan konstruksi yang unggul dan terpercaya dalam memberikan solusi pembangunan infrastruktur yang berkelanjutan dan berkualitas tinggi.
                    </p>
                  </div>
                  <div className="bg-white p-8 rounded-2xl shadow-lg">
                    <h3 className="text-2xl font-heading font-bold text-construction-blue-600 mb-6">Misi</h3>
      ...
      <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              {/* <div className="bg-white p-8 rounded-2xl shadow-lg border border-construction-gray-200">
                ...
                <div className="space-y-4">
                  <Button asChild className="w-full bg-construction-blue-600 hover:bg-construction-blue-700">
                    <Link to="/business-units/arimada-persada/projects">
                  ...
                  <Button asChild variant="outline" className="w-full border-construction-blue-600 text-construction-blue-600 hover:bg-construction-blue-50">
                    <Link to="/business-units/arimada-persada/download">
...
export default ArimadaPersadaProfile;